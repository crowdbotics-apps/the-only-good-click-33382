...
## Project Structure
    ...
    ├── the_only_good_click_33382  # Django project configurations
...
1. Clone this repo and `cd the_only_good_click_33382`
...
2. Clone this repo and `cd the_only_good_click_33382`
